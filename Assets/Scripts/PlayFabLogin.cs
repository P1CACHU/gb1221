...
public class PlayFabLogin : MonoBehaviour
{
	...
	private void OnCreateSuccess(RegisterPlayFabUserResult result)
	{
		...
		PlayFabClientAPI.GetPlayerCombinedInfo(new GetPlayerCombinedInfoRequest(), infoResult =>
		{
			Debug.Log(infoResult.InfoResultPayload.PlayerProfile.PlayerId);
		}, error => {var errorMessage = error.GenerateErrorReport();
